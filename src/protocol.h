...
#define MAX_PROTOCOL_BUFFER  4096
...
typedef enum {
	...
	eMSDP_TO_HIT,
	eMSDP_SPEED,
	eMSDP_RESIST_PHYSICAL,
	eMSDP_RESIST_MAGICAL,
	eMSDP_BONUS_PHYSICAL,
	eMSDP_BONUS_MAGICAL,
	eMSDP_BONUS_HEALING,
	
	// Empire
	eMSDP_EMPIRE_NAME,
	eMSDP_EMPIRE_ADJECTIVE,
	eMSDP_EMPIRE_RANK,
	eMSDP_EMPIRE_TERRITORY,
